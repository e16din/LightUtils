...
public class BadgeSetter {
    ...
    public BadgeSetter(View v, int bgResId) {
        ...
        LayoutParams paramsBadge = new LayoutParams(U.dpToPx(BADGE_BACKGROUND_HEIGHT),
                U.dpToPx(BADGE_BACKGROUND_HEIGHT));
        // paramsBadge.addRule(RelativeLayout.CENTER_VERTICAL);
        paramsBadge.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);

        paramsBadge.rightMargin = U.dpToPx(20);
        paramsBadge.topMargin = U.dpToPx(10);
        paramsBadge.bottomMargin = U.dpToPx(10);
        ...
        LayoutParams paramsCounter = new LayoutParams(U.dpToPx(BADGE_BACKGROUND_HEIGHT),
                U.dpToPx(BADGE_BACKGROUND_HEIGHT));
        ...
        tvBadge.setTextSize(U.dpToPx(BADGE_COUNTER_FONT_SIZE));
